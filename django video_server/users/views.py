...
from myadmin.models import MyChunkedUpload
...
class LikeListView(generic.ListView):
    ...
    def get_queryset(self):
        ...
        return videos
# user video add
class UserAddVideoView(TemplateView):
    template_name = 'users/video_add_.html'

class UserChunkedUploadView(ChunkedUploadView):
